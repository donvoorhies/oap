...
An "anthology" of (IMO) some snazzy Wordpress function-codes that I've come across over time, which I've earlier used to optimize Wordpress-installations with.
